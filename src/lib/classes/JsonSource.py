...
class JsonSource(FilesSources):
    def create_path(self):
        ...
        self.folder_path = os.path.join(current_directory, 'data', 'json_file')
    ...
    def check_for_new_files(self):
        ...
        if new_files:
            print("New Json file detected:", new_files)
        # Update the list of previous files
            self.previous_files = current_files
        else:
            print("No new Json file detected.")
    
    
    def get_data(self):
        # Implement getting data from JSON files in the specified folder
        data_frames = []
